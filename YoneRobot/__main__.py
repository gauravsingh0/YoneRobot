...
PM_START_TEXT = """
Hellow[🤗](https://telegra.ph/file/29dc600f7ce24cb852e57.jpg), I m pyrates a highly advanced bot having a lot of features.
`I'm here to manage ur groups! hit` /help   
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ show me ur place➕️", url="t.me/pyrates_Xrobot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="About", callback_data="pyrates_"),
        InlineKeyboardButton(
            text="support", url=f"https://t.me/pyrates_support"),
        ),
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [pyrates🙋‍♀️](https://telegra.ph/file/29dc600f7ce24cb852e57.jpg) 
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

yone_IMG = "https://telegra.ph/file/29dc600f7ce24cb852e57.jpg"
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *yone*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://github.com/gauravsingh0/pyrates.git).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *pyrates*
                 \nHere is the [Source Code]https://github.com/gauravsingh0/pyrates.git.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
